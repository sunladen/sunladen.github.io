document.head.innerHTML += '<link rel="stylesheet" href="https://code.cdn.mozilla.net/fonts/fira.css">';

fetch( '/drawdown/drawdown.css' )
    .then( response => response.text() )
    .then( text => document.head.innerHTML += `<style>${drawdown( text )}</style>` );

export default function drawdown( src ) {
