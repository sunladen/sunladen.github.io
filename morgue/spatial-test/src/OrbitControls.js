...
import { MOUSE } from 'threejs'
import { Quaternion } from 'threejs'
import { Spherical } from 'threejs'
...
export function OrbitControls( object, domElement ) {
    ...
    // custom modifications: make panLeft, panUp, dolly, rotateLeft, rotateUp public
    this.panLeft = function ( delta ) {

        panLeft( delta, scope.object.matrix );
        scope.update();

    };

    this.panUp = function ( delta ) {

        panUp( delta, scope.object.matrix );
        scope.update();
